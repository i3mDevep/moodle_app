...
class qtype_drawioflow_renderer extends qtype_renderer {
    ...
    $result .= html_writer::tag('div', $question->format_questiontext($qa), array('style' => 'min-height: 400px;', 'id' => $idiframe));
    ...
    // if ($options->readonly) {
    //     $result .= html_writer::tag('script', '', array('src' => ''.$CFG->wwwroot.'/question/type/drawioflow/javascript/disabled-editor.js', 'who' => 'iframe_'.$idiframe));
    // }
